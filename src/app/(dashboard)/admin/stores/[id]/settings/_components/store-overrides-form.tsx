...
export function StoreOverridesForm({ store, companySettings }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    await updateStore(store.id, {
      ...
      proformaPrefix: form.proformaPrefix || undefined,
      depositPrefix: form.depositPrefix || undefined,
      creditNotePrefix: form.creditNotePrefix || undefined,
      orderPrefix: form.orderPrefix || undefined,
